# Generated by Powerlevel10k configuration wizard on 2024-01-17 at 12:30 +08.
...
# angled separators, slanted heads, blurred tails, 2 lines, dotted, full frame, sparse,
...
() {
  ...
  function prompt_myprompt() {
    p10k segment -b red -f white -i $'\U1F331' -t $'\U1F331 Code with Passion, Strive for Excellence'
  }
